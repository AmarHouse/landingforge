...
export default function DownloadGeneratedContent({ 
  ...
  const captureGeneratedContent = (htmlString: string): string => {
    // First, strip any markdown code fences that the AI might have added
...
Generated by LandingForge - ${new Date().toISOString()}
...
All dynamic content has been converted to static content.
    ...
    // DOMParser strips DOCTYPE from outerHTML, so always prepend it.
    // This is harmless if the original already had one and avoids missing DOCTYPE.
...
Generated by LandingForge on ${new Date().toLocaleString()}
