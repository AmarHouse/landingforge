...
export function PromptHistory({ onSelectPrompt, disabled, currentStyle }: PromptHistoryProps) {
          ...
          <div className="flex gap-1">
            {['all', 'classic', 'enhanced', 'style'].map((filter) => (
              <Button
                ...
                onClick={() => setFilterMode(filter as 'all' | 'classic' | 'enhanced' | 'style')}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <Button
                          size="xs"
                          variant="ghost"
                          onClick={(e: React.MouseEvent) => handleDeletePrompt(entry.id, e)}
