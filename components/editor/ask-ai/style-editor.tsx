...
import { Plus, Save, X, Palette, Type, Sparkles, Eye } from "lucide-react";
...
import { saveCustomStyle } from "@/lib/custom-styles";
      ...
      <DialogContent className="!rounded-2xl !w-[50rem] max-h-[90vh] overflow-hidden !bg-neutral-900 border-neutral-700">
        ...
        <div className="flex border-b border-neutral-800">
          {[
            ...
            <button
              key={id}
              onClick={() => setActiveTab(id as 'basic' | 'advanced' | 'preview')}
            ...
            <div className="space-y-4 p-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={formData.category} onValueChange={(value) => setFormData(prev => ({ ...prev, category: value as 'flat' }))}>
