...
export function Footer({
  ...
  return (
    <footer className="border-t bg-slate-200 border-slate-300 dark:bg-neutral-950 dark:border-neutral-800 px-3 py-2 flex items-center justify-between sticky bottom-0 z-20">
      ...
      <a href="https://resende.com.br/lp/pedroluz" target="_blank" rel="noopener noreferrer" className="text-xs text-neutral-500 hover:text-neutral-300 transition-colors hidden md:block">
        Developed by Pedro Luz
      </a>
      <div className="flex justify-end items-center gap-2.5">
        {onOpenSettings && (
          <Button size="sm" variant="ghost" onClick={onOpenSettings}>
            <PiGearSixFill className="size-3.5" />
