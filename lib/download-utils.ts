// Download utilities for LandingForge - Client-side only
import React from 'react';

// Simple PDF generation as a fallback
export const downloadAsPdfSimple = async (iframeRef: React.RefObject<HTMLIFrameElement | null>, filename: string = 'website.pdf') => {
...
export const downloadAsPdfText = async (iframeRef: React.RefObject<HTMLIFrameElement | null>, filename: string = 'website.pdf') => {
  if (!iframeRef.current) {
    throw new Error('Preview not available');
  }
...
export const downloadAsPdf = async (iframeRef: React.RefObject<HTMLIFrameElement | null>, filename: string = 'website.pdf') => {
  if (!iframeRef.current) {
    throw new Error('Preview not available');
  }
...
export const downloadAsImage = async (iframeRef: React.RefObject<HTMLIFrameElement | null>, filename: string = 'website-screenshot.png') => {
  if (!iframeRef.current) {
    throw new Error('Preview not available');
  }
...
export const downloadAsFullPageImage = async (iframeRef: React.RefObject<HTMLIFrameElement | null>, filename: string = 'website-fullpage.png') => {
  if (!iframeRef.current) {
    throw new Error('Preview not available');
  }
