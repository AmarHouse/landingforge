# Remark: this is a draft concept paper in what my LandingForge system might evolve. Renamed into DeepLearn maybe :). My current system if for me more a proof of concept - that something like this is possible. For questions/comments I am open for discussion. 
