...
LandingForge now includes a comprehensive design style selector that allows you to generate websites in various artistic and functional styles. From hand-drawn sketches to professional presentations, you can choose the perfect aesthetic for your project.

## How to Use the Style Selector

### Accessing the Style Selector
1. Open any AI chat interface in LandingForge
